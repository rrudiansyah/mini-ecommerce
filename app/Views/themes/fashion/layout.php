...
<head>
    ...
    <title><?= htmlspecialchars($store['name'] ?? '') ?> — Fashion</title>
...
<section id="hero">
    ...
    <div>
        <div class="hero-tag">👗 Fashion & Thrift</div>
        <h1 class="hero-title">Tampil <em>Stylish</em><br>& Berkelas</h1>
        <p class="hero-sub">Temukan koleksi pakaian berkualitas dengan sentuhan alami. Dari thrift hingga busana baru, semua ada di sini.</p>
        <div class="hero-btns">
    ...
    <div class="hero-visual">
        ...
        <div class="hero-float hero-float-1"><div class="dot-green"></div> Stok Terbaru</div>
        <div class="hero-float hero-float-2">🌿 Eco Fashion</div>
    </div>
</section>
...
<section id="services">
    <div class="sec-hd">
        ...
        <h2 class="sec-title">Pilih Koleksi Favoritmu</h2>
        <p class="sec-sub">Pilih item favoritmu dan pesan langsung</p>
    </div>
    <?php if(empty($menu)): ?>
...
<footer id="footer">
    ...
    <p class="footer-tag">Fashion & Thrift Profesional</p>
...
<div class="overlay" id="overlay" onclick="closeOnOverlay(event)">
    <div class="cart-sidebar">
        ...
        <div id="cartView">
            <div class="cart-items" id="cartItems"><div class="cart-empty">🛒 Belum ada item</div></div>
        ...
        <div id="formView" class="order-form">
            <div class="cart-items">
                ...
                <div class="form-field"><label>Catatan</label><textarea id="custNote" placeholder="Contoh: ukuran S, warna biru......"></textarea></div>
        ...
        <div class="order-success" id="successView">
            <div class="cart-items" style="display:flex;align-items:center;justify-content:center;">
                <div>
                    ...
                    <p class="success-sub">Konfirmasi via WhatsApp untuk konfirmasi stok dan pengiriman.</p>
