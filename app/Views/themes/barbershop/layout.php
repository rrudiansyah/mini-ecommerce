...
<head>
    ...
    <title><?= htmlspecialchars($store['name'] ?? '') ?> — Barbershop</title>
...
<section id="hero">
    ...
    <div>
        <div class="hero-tag">✂️ Barbershop & Salon</div>
        <h1 class="hero-title">Tampil <em>Segar</em><br>& Percaya Diri</h1>
        <p class="hero-sub">Dipotong oleh tangan terampil dengan teknik modern dan produk perawatan terbaik untuk hasil yang memukau.</p>
        <div class="hero-btns">
    ...
    <div class="hero-visual">
        <div class="hero-img-box">✂️</div>
        <div class="hero-float hero-float-1"><div class="dot-green"></div> Tersedia Hari Ini</div>
        <div class="hero-float hero-float-2">💈 Barbershop Pro</div>
    </div>
</section>
...
<section id="services">
    <div class="sec-hd">
        ...
        <h2 class="sec-title">Pilih Layanan Favoritmu</h2>
        <p class="sec-sub">Tambahkan ke keranjang, lalu pesan dengan mudah</p>
    </div>
    <?php if(empty($menu)): ?>
...
<footer id="footer">
    <div class="footer-logo">✂️ <?=htmlspecialchars($store['name'] ?? '')?></div>
    <p class="footer-tag">Barbershop & Salon Profesional</p>
...
<div class="overlay" id="overlay" onclick="closeOnOverlay(event)">
    <div class="cart-sidebar">
        ...
        <div id="cartView">
            <div class="cart-items" id="cartItems"><div class="cart-empty">🛒 Keranjang kosong</div></div>
        ...
        <div id="formView" class="order-form">
            <div class="cart-items">
                ...
                <div class="form-field"><label>Catatan</label><textarea id="custNote" placeholder="Contoh: rapi di samping, jangan terlalu pendek..."></textarea></div>
        ...
        <div class="order-success" id="successView">
            <div class="cart-items" style="display:flex;align-items:center;justify-content:center;">
                <div>
                    ...
                    <p class="success-sub">Konfirmasi via WhatsApp agar kami siapkan jadwalmu.</p>
