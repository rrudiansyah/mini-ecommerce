...
<section id="menu">
    ...
    <div class="menu-section <?= $first ? 'active' : '' ?>" id="cat-<?= $catId ?>">
        <div class="product-grid">
            ...
            <div class="product-card" onclick="addToCart(<?= $p['id'] ?>, '<?= htmlspecialchars($p['name'] ?? '', ENT_QUOTES) ?>', <?= $p['price'] ?>, '<?= htmlspecialchars($p['image'] ?? '', ENT_QUOTES) ?>')">
                ...
                <div class="product-body">
                    ...
                    <div class="product-footer">
                        ...
                        <button class="add-btn" onclick="event.stopPropagation(); addToCart(<?= $p['id'] ?>, '<?= htmlspecialchars($p['name'] ?? '', ENT_QUOTES) ?>', <?= $p['price'] ?>, '<?= htmlspecialchars($p['image'] ?? '', ENT_QUOTES) ?>')">+</button>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
